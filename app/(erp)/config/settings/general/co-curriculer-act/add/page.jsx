// app/(erp)/config/settings/general/co-curricular/add/page.jsx
"use client";
...
export default function AddCoCurricularPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      await api.post("/v1/general-settings/co-curriculer-act", formData);
      router.push("/config/settings/general/co-curriculer-act");
    } catch (error) { alert("Failed to add activity"); } 
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-[#f4f5f8] pb-2 border-b border-gray-200">
        ...
        <Link href="/config/settings/general/co-curriculer-act" className="border border-gray-300 text-gray-600 hover:bg-gray-100 rounded-sm px-4 py-2 text-sm font-medium">BACK TO LIST</Link>
      </div>
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
            <Link href="/config/settings/general/co-curriculer-act" className="bg-[#9fa8b6] hover:bg-gray-500 text-white px-6 py-2 rounded-sm font-medium text-sm">Cancel</Link>
